...
public class SistemskaOperacijaVratiListuLetovaDanasSaAerodroma {
		
	public List<Let> izvrsiSistemskuOperacijuVratiListuLetovaDanasSaAerodroma(int id,String datum) {
	...
	private List<Let> izvrsiKonkretnuOperaciju(int id,String datum) {
		...
		List<Let> list = ib.vratiListuLetovaDanasSaAerodroma(id,datum);
		return list;
