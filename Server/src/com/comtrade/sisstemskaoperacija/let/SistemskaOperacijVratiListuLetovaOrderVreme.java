...
public class SistemskaOperacijVratiListuLetovaOrderVreme {
	
	public List<Let> izvrsiSistemskuOperacijuVratiListuLetovaOrderVreme(int id,String datum) {
	...
	private List<Let> izvrsiKonkretnuOperaciju(int id,String datum) {
		...
		List<Let> list = ib.vratiListuLetovaOrderVreme(id,datum);
		return list;
