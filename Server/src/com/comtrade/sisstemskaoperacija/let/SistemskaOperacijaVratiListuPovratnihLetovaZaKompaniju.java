...
public class SistemskaOperacijaVratiListuPovratnihLetovaZaKompaniju {
	
	public List<Let> izvrsiSistemskuOperacijuVratiListuPovratnihLetovaZaKompaniju(Let let) {
	...
	private List<Let> izvrsiKonkretnuOperaciju(Let let) {
		...
		List<Let> list = ib.vratiListuPovratnihLetovaZaKompaniju(let);
		return list;
