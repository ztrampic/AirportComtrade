...
public class SistemskaOperacijaVratiMaximumPoletanja {
	public int izvrsiSistemskaOperacijaVratiMaximumPoletanja(Object obj) {
		int vrednost = 0;
		try {
			pokreniTransakciju();
	...
	private int izvrsiKonkretnuOperaciju(Object obj) {
		...
		int vrednost = ib.vratiMaxPoletanja(id);
		return vrednost;
