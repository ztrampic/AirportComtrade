...
public class SistemskaOperacijaVratiBrojPoletanjaZaDatum {
	public int izvrsiSistemskuOperacijuVratiBrojPoletanjaZaDatum(String datum, int id) {
		int vrednost = 0;
		try {
			pokreniTransakciju();
	...
	private int izvrsiKonkretnuOperaciju(String datum, int id) {
		...
		int vrednost = ib.vratiVrednostBrojaLetovaZaDatum(datum,id);
		return vrednost;
