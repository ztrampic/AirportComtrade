...
public class SistemskaOperacijaVratiListuRezervacijaZaIdLeta {
		
	public List<Rezervacija> izvrsiSistemskuOperacijuVratiListuRezervacijaZaIdLeta(int id) {
	...
	private List<Rezervacija> izvrsiKonkretnuOperaciju(int id) {
		...
		List<Rezervacija> list = ib.vratiListuRezervacijaZaIdLeta(id);
		return list;
